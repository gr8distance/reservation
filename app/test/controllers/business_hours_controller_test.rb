...
class BusinessHoursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create business_hour" do
    assert_difference("BusinessHour.count") do
      post business_hours_url, params: { business_hour: { end_at: @business_hour.end_at, start_at: @business_hour.start_at } }
    end
  ...
  test "should update business_hour" do
    patch business_hour_url(@business_hour), params: { business_hour: { end_at: @business_hour.end_at, start_at: @business_hour.start_at } }
